...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Manuel Werlberger"
    user-mail-address "code@werlberger.org")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/mw/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/mw/bin" "/profile/bin" "/Users/mw/.npm-packages/bin" "/Users/mw/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
